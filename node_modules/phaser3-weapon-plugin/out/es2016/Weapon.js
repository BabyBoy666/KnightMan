...
class Weapon extends Phaser.Events.EventEmitter {
    ...
    fireAtPointer(pointer) {
        ...
        return this.fire(null, pointer === null || pointer === void 0 ? void 0 : pointer.x, pointer === null || pointer === void 0 ? void 0 : pointer.y);
    }
    /**
    ...
    fire(from, x, y, offsetX = 0, offsetY = 0) {
        ...
        const fromY = this.fireFrom.height > 1
            ...
            : this.fireFrom.y;
        let angle = typeof ((_a = this.trackedSprite) === null || _a === void 0 ? void 0 : _a.angle) === 'number' && this.trackRotation
        ...
        if (this.autoExpandBulletsGroup) {
            ...
            bullet === null || bullet === void 0 ? void 0 : bullet.setData('bulletManager', this);
        }
        else {
