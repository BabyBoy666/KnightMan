...
class Bullet extends Phaser.GameObjects.Sprite {
    ...
    prepare(x, y) {
        ...
        this.body.reset(x, y);
        const debugPhysics = ((_a = this.getData('bulletManager')) === null || _a === void 0 ? void 0 : _a.debugPhysics) || false;
    ...
    kill() {
        ...
        (_a = this.getData('bulletManager')) === null || _a === void 0 ? void 0 : _a.emit(BULLET_KILL, this, this.getData('bulletManager'));
        return this;
    }
    /**
