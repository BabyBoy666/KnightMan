 ...
 * ```
 */
declare class WeaponPlugin extends Phaser.Plugins.ScenePlugin {
    weapons: Weapon[];
    /**
     ...
     */
    add(bulletLimit?: number, key?: string, frame?: string, group?: Phaser.GameObjects.Group, weaponClass?: typeof Weapon): Weapon;
    /**
